...
template<typename T1, typename T2>
typename Tree<T1, T2>::TNode* Tree<T1, T2>::find_node(T1 key) {
    bool found = false;
...
template<typename T1, typename T2>
list<typename Tree<T1, T2>::TNode*> Tree<T1, T2>::roam(TNode* start) {
    list<TNode*> nodes;
...
template<typename T1, typename T2>
void Tree<T1, T2>::exclude(T1 key) {
...
template<typename T1, typename T2>
list<pair<T1, T2>> Tree<T1, T2>::to_list() {
...
template<typename T1, typename T2>
bool Tree<T1, T2>::KeyUnique(pair<T1, T2> p1, pair<T1, T2> p2) {
    return (p1.first == p2.first);
}
template<typename T1, typename T2>
void Tree<T1, T2>::merge(Tree t) {
